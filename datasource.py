...
class DataSource:
    ...
    def getRandomGames(self):
        randRank = random.randint(1,60)
        query = 'SELECT game_name, avg_time, rank, category, min_age, designer FROM boardgames WHERE rank =' + str(randRank)
